...
# cascade_ped_src = 'haarcascade_fullbody.xml'
...
while True:
    ...
    peds, weights = hog.detectMultiScale(img, winStride=(8,8))
    ...
    for(a,b,c,d) in peds:
        cv2.rectangle(img,(a,b),(a+c,b+d),(164,11,255),4)

    print(len(cars)+len(bus)+len(bike)+len(peds)) #COUNTER IS HERE!
    # print(len(boxes)) #COUNTER IS HERE!
